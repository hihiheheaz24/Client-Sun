    ...
    ServerConnector = (function () {
        ...
        ServerConnector.prototype.sendRequest = function (subdomain, url, callback) {
            ...
            try {
                ...
                if (subdomain === cc.SubdomainName.DRAGON_TIGER|| subdomain === cc.SubdomainName.XENG_777 || subdomain === cc.SubdomainName.XOC_XOC || subdomain === cc.SubdomainName.CHAT
                ...
                // cc.log("check subdomain : ", subdomain , " host ", host)
                ...
                console.log("check url request : ", urlRequest)
