...
(function () {
    ...
    cc.PopupView = cc.Class({
        ...
        properties: {
            ...
            sfMessageWarning: cc.SpriteFrame,
        ...
        showBusy: function (timeout = false, timeoutHide = false) {
            if (this.timeOutBusy != null) clearTimeout(this.timeOutBusy);
            if(timeoutHide){
                this.nodeBusy.active = true;
                this.timeOutBusy = setTimeout(() => {
        ...
        showMessage: function (message, code) {
            ...
            this.lbMessage.node.color = cc.Color.WHITE;
            this.showMess(message, code);
        },

        showMessageError: function (message, code) {
            this.spriteMessage.spriteFrame = this.sfMessageError;
            this.lbMessage.node.color = cc.Color.RED;
            this.showMess(message, code);
        },
        showMessageWarning: function (message) {
            this.spriteMessage.spriteFrame = this.sfMessageWarning;
            this.lbMessage.node.color = cc.Color.YELLOW;
            this.showMess(message,-1);
        },

        showMess: function (message, code) {
            if (this.nodeMessage.active) {
            ...
            this.nodeMessage.getComponent(cc.Animation).play('messagePop');
        },
        ...
        onGetOTPResponseError: function (response) {
            setTimeout(function(){
                if(response.ResponseCode === -3 && this.otpType && this.otpType === cc.OTPType.TELE_GRAM){
