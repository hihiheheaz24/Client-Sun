...
(function () {
    ...
    PopupController = (function () {
        ...
        PopupController.prototype.showBusy = function (timeout = false, timeoutHide = false) {
            return this.popupView.showBusy(timeout, timeoutHide);
        };
        ...
        PopupController.prototype.showMessageWarning = function (message) {
            return this.popupView.showMessageWarning(message);
        };
