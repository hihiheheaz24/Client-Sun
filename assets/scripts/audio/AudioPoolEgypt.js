...
(function () {
    cc.AudioPoolEgypt = cc.Class({
        ...
        properties: {
            ...
            waitForPlayBonus: cc.AudioSource,
            spin: cc.AudioSource,
            ...
            winJackpot: cc.AudioSource,

            countSound: cc.AudioSource,
            countEndSound: cc.AudioSource,
            crazy: cc.AudioSource,
        },
        ...
        enableSound: function (enable) {
            if (this.normalWin) {
                ...
                this.waitForPlayBonus.mute = !enable;
                ...
                this.countSound.mute = !enable;
                this.countEndSound.mute = !enable;
                this.crazy.mute = !enable;
                if(this.winJackpot){
                    this.winJackpot.mute = !enable;
                }
        ...
        getAudioClip: function (clipType) {
            ...
            switch (clipType) {
                ...
                case cc.AudioTypes.BONUS_START:
                    audioClip = this.waitForPlayBonus;
                    break;
                ...
                case cc.AudioTypes.EXPAND_WILD:
                    ...
                    break;
                case cc.AudioTypes.COUNT:
                    audioClip = this.countSound;
                    break;
                case cc.AudioTypes.COUNT_END:
                    audioClip = this.countEndSound;
                    break;
                case cc.AudioTypes.CRAZY_GAME:
                    audioClip = this.crazy;
                    break;
            }
            return audioClip;
        }
