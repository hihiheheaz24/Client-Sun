...
(function () {
    ...
    LobbyController = (function () {
        ...
        LobbyController.prototype.createNewsView = function () {
            return this.lobbyView.createNewsView();
        };

        LobbyController.prototype.destroyNewsView = function () {
            return this.lobbyView.destroyNewsView();
        };
        ...
        LobbyController.prototype.createViewXocDia = function (prefab, config) {
            return this.lobbyView.createViewXocDia(prefab, config);
        };

        LobbyController.prototype.destroyViewXocDia = function () {
            return this.lobbyView.destroyDynamicView(cc.GameId.XOC_XOC);
        };
        ...
        LobbyController.prototype.createShopCastOutView = function (startTab) {
            ...
            if (startTab === cc.ShopTab.TOPUP || startTab === cc.ShopTab.BANK || startTab === cc.ShopTab.LOAN || startTab === cc.ShopTab.MOMO
                || startTab === cc.ShopTab.TRANSFER || startTab === cc.ShopTab.REDEEM_REWARD || startTab === cc.ShopTab.SPEND_GVIN) {
...
/////////////////////////////////
        LobbyController.prototype.createSupportView = function () {
            return this.lobbyView.createSupportView();
        };

        LobbyController.prototype.createDownloadView = function () {
            return this.lobbyView.createDownloadView();
        };
///////////////////////////////////
        ...
        LobbyController.prototype.activeCardGame = function (isLobby) {
            return this.lobbyView.activeCardGame(isLobby);
        };
        ...
        LobbyController.prototype.ShowLoginPopup = function (enable) {
            return this.topBarView.loginClicked();
        };
        ...
        LobbyController.prototype.createPopupJackpotView = function () {
            return this.lobbyView.createPopupJackpotView();
        };

        LobbyController.prototype.destroyPopupJackpotView = function () {
            return this.lobbyView.destroyPopupJackpotView();
        };
//LivestreamView
        LobbyController.prototype.setLiveXocDiaView = function (view) {
            return this.liveXocDiaView = view;
        };
        LobbyController.prototype.setActiveLiveXocDia = function (active) {
            if (this.liveXocDiaView) {
                return this.liveXocDiaView.setActiveLiveXocDia(active);
            }
        };
        LobbyController.prototype.setActiveLiveXocDiaFromLobby = function () {
            if (this.liveXocDiaView) {
                return this.lobbyView.setActiveLiveXocDia();
            }
        };
        LobbyController.prototype.AddMiniGameCount = function (amount) {
            if (!this.minigameCount)
            {
                this.minigameCount = amount;
            }
            else
                this.minigameCount +=amount;
        };
        LobbyController.prototype.GetMiniGameCount = function () {
            return this.minigameCount;
        };
        LobbyController.prototype.setODPStatus = function (status) {
            return this.ODPStatus = status;
        };
        LobbyController.prototype.getODPStatus = function () {
            return this.ODPStatus;
        };
