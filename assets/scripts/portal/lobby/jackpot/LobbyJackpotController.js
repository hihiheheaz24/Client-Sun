...
(function () {
    ...
    LobbyJackpotController = (function () {
        ...
        LobbyJackpotController.prototype.setX6JackpotResponse = function (x6JackpotResponse) {
            return this.x6JackpotResponse = x6JackpotResponse;
        };

        LobbyJackpotController.prototype.getX6JackpotResponse = function () {
            return this.x6JackpotResponse;
        };
