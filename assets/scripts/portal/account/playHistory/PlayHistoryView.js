cc.Class({
    ...
    updateDataByPageIndex(pageIndex){
        ...
        this.listItem.forEach((item,index)=>{
            if(result[index]){
                item.active = true;
                item.getComponent(cc.PlayHistoryItem).updateItem(result[index],pageIndex*this.totalItemOfPage+index);
            } else {
                item.active = false;
            }
        });
    ...
    onEnable () {
        ...
        let AllGameHistoryCommand = new cc.AllGameHistoryCommand;
        AllGameHistoryCommand.execute(this);
        this.buttonFirst.interactable = false;
        this.buttonBack.interactable = false;
        this.buttonLast.interactable = false;
        this.buttonNext.interactable = false;
    ...
    onAllGameHistoryResponse (response) {
