...
(function () {
    ...
    onLoad(){
        ...
        this.currentPage = 1;
        this.data = [];
        this.node.zIndex = cc.NoteDepth.TAI_XIU;
    },
    ...
    updateDataByPageIndex(pageIndex){
        ...
        this.listItem.forEach((item,index)=>{
            if(result[index]){
                item.active = true;
                item.getComponent(cc.TransferTransactionItem).updateItem(result[index],pageIndex*this.totalItemOfPage+index);
            } else {
                item.active = false;
            }
        });
    ...
    onEnable () {
        ...
        var GetUserTransferHistoryCommand = new cc.GetUserTransferHistoryCommand;
        GetUserTransferHistoryCommand.execute(this);
        this.buttonFirst.interactable = false;
        this.buttonBack.interactable = false;
        this.buttonLast.interactable = false;
        this.buttonNext.interactable = false;
        ...
        onUserTransferHistoryResponse (response) {
