...
(function () {
    cc.DoiTheRateView = cc.Class({
        ...
        init: function (controller) {
            ...
            this.topupView = controller.getComponent(cc.DoiThe);
            
            let lowerCase = cc.CardType.VIETTEL.toString().toLowerCase();
            this.topupView.setLBCardType(this.jsUcfirst(lowerCase));
        },
