cc.Class({
    ...
    updateDataByPageIndex(pageIndex){
        ...
        this.listItem.forEach((item,index)=>{
            if(result[index]){
                item.active = true;
                item.getComponent(cc.HistoryPaymentItem).updateItem(result[index]);
            } else {
                item.active = false;
            }
        });
    ...
    onEnable () {
        ...
        this.urlParams = localStorage.getItem('historyRechargeCashoutParams');
        let getHistoryCommand = new cc.GetHistoryPaymentCommand;
    ...
    onGetHistoryPaymentSuccess (response) {
    ...
    onGetHistoryPaymentError (response) {
