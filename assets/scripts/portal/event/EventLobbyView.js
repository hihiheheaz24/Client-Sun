...
(function () {
    cc.EventLobbyView = cc.Class({
        ...
        properties: {
            ...
            nodeLogoCaoThap: cc.Node,
            nodeLogoBlockBuster: cc.Node,
            nodeLogoTX: cc.Node,
            nodeLogo777: cc.Node,
            nodeLogoXeng777: cc.Node,
        ...
        reset: function () {
            ...
            this.nodeLogoCaoThap.active = false;
