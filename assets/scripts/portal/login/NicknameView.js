    ...
    cc.NicknameView = cc.Class({
        ...
        showNickname: function (enable) {
            ...
            if (enable) {
                ...
                this.node.zIndex =  cc.NoteDepth.NICK_NAME_VIEW;
                cc.LoginController.getInstance().getzIndexWidgetHeader().activeBlock(true);
            } 
            this.lbUserName.string = `${cc.Tool.getInstance().getItem('@usernameLabel').toString()}`;
        },
        ...
        onUpdateNicknameResponse: function(response) {
            ...
            cc.LoginController.getInstance().getzIndexWidgetHeader().activeBlock(false);
