...
(function () {
    cc.SafeArea = cc.Class({
        ...
        onLoad: function () {
            ...
            this.rect = cc.sys.getSafeAreaRect();
            console.log('getSafeAreaRect' + this.rect);

            // if (this.rect.x > 10) {
            //     this.leftMenu = cc.find('Canvas/widget-left/offset-left');
            //     this.leftMenu.x += (this.rect.x - 10);
            // }
        },
    });
