(function () {
    cc.Avatar = cc.Class({
        ...
        getAvatar: function (imageUrl) {
            // var self = this;
            // cc.assetManager.loadRemote({url: imageUrl, type: 'png', width: 256, height: 256}, function (err, tex) {
            //     if (self.node !== null) {
        ...
        load: function (fbId) {
            var self = this;
            // var imageUrl = 'https://graph.facebook.com/' + fbId + '/picture?redirect=false&width=512&height=512';
