...
(function () {
    ...
    var GROUP_FB_B1 = 'https://t.me/';
    var FANPAGE_FB_B1 = 'https://t.me/'; //icon hotro ( homepage)

    var GROUP_FB_B2 = 'https://t.me/';
    var FANPAGE_FB_B2 = 'https://t.me/';

    var GROUP_FB_B3 = 'https://t.me/';
    var FANPAGE_FB_B3 = 'https://t.me/';

    var GROUP_FB_B4 = 'https://t.me/';
    var FANPAGE_FB_B4 = 'https://t.me/';

    var TELE_HOTRO = 'https://t.me/'; //chattelgrams
	var FONE_SUPPORT = 'https://t.me/'; //SDT
    var TAI_OTP_X6 = 'tg://resolve?domain=g11gamebot'; //baomat
    ...
    //FAKE 2
    var GROUP_FB_B1_F = 'https://web.telegram.org/';
    var FANPAGE_FB_B1_F = 'https://www.facebook.com/';

    var GROUP_FB_B2_F = 'https://web.telegram.org/';
    var FANPAGE_FB_B2_F = 'https://www.facebook.com/';

    var GROUP_FB_B3_F = 'https://web.telegram.org/';
    var FANPAGE_FB_B3_F = 'https://www.facebook.com/';
    ...
    Config = (function () {
        ...
        Config.prototype.getGameName = function (gameId) {
            switch (gameId.toString()) {
                ...
                case cc.GameId.TAY_DU_THAN_KHI:
                    return cc.GameName.TAY_DU_THAN_KHI;

                case cc.GameId.THAN_THU:
                    return cc.GameName.THAN_THU;
        ...
        Config.prototype.getSubDomainByHub = function (hubName) {
            switch (hubName) {
                ...
                case cc.HubName.ThuyCungHub:
                    return cc.SubdomainName.THUY_CUNG;
                ...
                case cc.HubName.TayDuThanKhiHub:
                    return cc.SubdomainName.TAY_DU_THAN_KHI;
                case cc.HubName.ThanThuHub:
                    return cc.SubdomainName.THAN_THU;
                ...
                case cc.HubName.XocDiaLiveHub:
                    return cc.SubdomainName.XOC_DIA_LIVE;
                case cc.HubName.BauCuaHub:
                    return cc.SubdomainName.BAUCUA;
                    case cc.HubName.SicBoHub:
                ...
                case cc.HubName.LuckyDice1Hub:
                    return cc.SubdomainName.TAI_XIU1;
                case cc.HubName.LuckyDice2Hub:
                    return cc.SubdomainName.TAI_XIU2;
        ...
        Config.prototype.teleHotro = function () {
		 ...
		 Config.prototype.foneSupport = function () {
            return FONE_SUPPORT;
        };
