...
(function () {
    ...
    TaiXiuMainController = (function () {
        ...
        TaiXiuMainController.prototype.createUserWinJackpotView = function () {
            return this.taiXiuMainView.createUserWinJackpotView();
        };

        TaiXiuMainController.prototype.destroyUserWinJackpotView = function () {
            return this.taiXiuMainView.destroyUserWinJackpotView();
        };
