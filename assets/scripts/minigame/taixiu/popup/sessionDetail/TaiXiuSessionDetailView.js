...
(function () {
    cc.TaiXiuSessionDetailView = cc.Class({
        ...
        getSessionDetailById: function (index) {
            ...
            this.lbSessionID.string = 'Phiên: #' + game.SessionId + '\n'
            ...
            this.nodeEffectTais.forEach(function (nodeEffect) {
                nodeEffect.active = isTai;
            });
            this.nodeEffectXius.forEach(function (nodeEffect) {
                nodeEffect.active = !isTai;
            });
        ...
        onTXGetSessionInfoResponse: function (response) {
            ...
            this.lbTotalBetTai.string = cc.Tool.getInstance().formatNumber(totalBetTai);
            this.lbTotalBetXiu.string = cc.Tool.getInstance().formatNumber(totalBetXiu);
            this.lbTotalRefundTai.string = cc.Tool.getInstance().formatNumber(totalRefundTai);
            this.lbTotalRefundXiu.string = cc.Tool.getInstance().formatNumber(totalRefundXiu);
        },
