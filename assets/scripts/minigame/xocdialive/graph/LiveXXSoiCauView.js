...
(function () {
    cc.LiveXXSoiCauView = cc.Class({
        ...
        onLoad: function () {
            cc.LiveXXController.getInstance().setLiveXXSoiCauView(this);

            // this.rootPosX = -9.6; //toa do goc
            // this.rootPosY = -47; //toa do goc

            this.rootPosX = -8.625; //toa do goc
            this.rootPosY = -43.75; //toa do goc
        ...
        getSide: function (gate) {
            switch (gate) {
                case cc.LiveXXResult.EVEN:
                    return 'EVEN';
                case cc.LiveXXResult.EVEN_FOUR_DOWN:
                    return 'EVEN';
                case cc.LiveXXResult.EVEN_FOUR_UP:
                    return 'EVEN';
                case cc.LiveXXResult.ODD_THREE_DOWN:
                    return 'ODD';
                case cc.LiveXXResult.ODD_THREE_UP:
                    return 'ODD';
            }
        },
        ...
        draw: function (list) {
            ...
            var length = Math.min(matrix.length, 12);
        ...
        createNode: function (item, pos) {
            ...
            //     this.gameAssets = cc.LiveXXController.getInstance().getAssets();
            // }
