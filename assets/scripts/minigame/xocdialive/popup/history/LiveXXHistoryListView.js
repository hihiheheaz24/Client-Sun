...
(function () {
    cc.LiveXXHistoryListView = cc.Class({
        "extends": cc.ListView,
        properties: {
        ...
        initialize: function (messages) {
            ...
            var spawnCountReal = this.messages.length;

            for (var i = 0; i < spawnCountReal; ++i) {
                var item = cc.instantiate(this.itemTemplate);
                this.content.addChild(item);
                item.getComponent(cc.LiveXXHistoryItem).updateItem(this.messages[i], i);
        ...
        update: function (dt) {
            ...
            //             var item = items[i].getComponent(cc.LiveXXHistoryItem);
            ...
            //             items[i].y  = (items[i].y - offset);
            //             item = items[i].getComponent(cc.LiveXXHistoryItem);
