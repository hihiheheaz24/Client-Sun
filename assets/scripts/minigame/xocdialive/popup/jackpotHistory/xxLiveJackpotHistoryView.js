cc.Class({
    ...
    updateDataByPageIndex(pageIndex){
        ...
        this.listItem.forEach((item,index)=>{
            if(result[index]){
                item.active = true;
                item.getComponent(cc.xxLiveJackpotHistoryItem).updateItem(result[index]);
            } else {
                item.active = false;
            }
        });
    ...
    onEnable () {
        ...
        let LiveXXGetJackpotHistoryCommand = new cc.LiveXXGetJackpotHistoryCommand;
        LiveXXGetJackpotHistoryCommand.execute(this);
        this.buttonFirst.interactable = false;
        this.buttonBack.interactable = false;
        this.buttonLast.interactable = false;
        this.buttonNext.interactable = false;
    ...
    onLiveXXGetJackpotHistoryResponse (response) {
        let data = response;
    ...
    closeClicked () {
        cc.LiveXXPopupController.getInstance().destroyJackpotHistoryView();
