...
// var BauCuaGraphViewNew = require('BauCuaGraphViewNew');
(function () {
    cc.BauCuaView = cc.Class({
        ...
        properties: {
            ...
            // bauCuaGraphViewNew: BauCuaGraphViewNew,
            _listUserBets: [],
        },
                ...
                res.map(m => {
                    switch (m.M) {
                        ...
                        case cc.MethodHubOnName.SESSION_INFO:
                            ...
                            if (m.A[0].Phrase == cc.BauCuaPharse.EndBetting && this._listUserBets.length > 0) {
                                this._listUserBets.forEach(m => {
                        ...
                        case cc.MethodHubOnName.GAME_HISTORY:
                            ...
                            // this.bauCuaGraphViewNew.updateListItem(m.A[0]);
                            break;
