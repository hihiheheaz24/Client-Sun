...
(function () {
    cc.BauCuaTopListView = cc.Class({
        ...
        initialize: function (messages) {
            ...
            this.messages = this.messages.filter(c => (c.UserName != null));
            ...
            for (var i = 0; i < spawnCountReal; ++i) {
                ...
                item.getComponent(cc.BauCuaTopItem).updateItem(this.messages[i], i);
            ...
            for (var i = 0; i < items.length; ++i) {
                ...
                if (isDown) {
                    ...
                    if (viewPos.y < -buffer && items[i].y + offset < 0) {
                        ...
                        var item = items[i].getComponent(cc.BauCuaTopItem);
                    ...
                    if (viewPos.y > buffer && items[i].y - offset > -this.content.height) {
                        items[i].y = (items[i].y - offset);
                        item = items[i].getComponent(cc.BauCuaTopItem);
