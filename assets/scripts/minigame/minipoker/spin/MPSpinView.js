...
(function () {
    cc.MPSpinView = cc.Class({
        ...
        setTotalTicket(totalTicket){
            this.lbTotalTicket.string = totalTicket ? totalTicket: "0";
        },

        onEnable: function () {
            this.lbiTotalWin.setValue(0);
            this.lbTotalTicket.string = 0;
        },
        ...
        playEffect: function () {
            ...
            //cheat
            // this.spinResponse.NewTicket = 2;
            // this.spinResponse.totalTicket = 3;
            if(this.spinResponse.NewTicket) {
                cc.MPEffectController.getInstance().playEffectGoldTicket(this.spinResponse.NewTicket, ()=>{
                    this.setTotalTicket(this.spinResponse.totalTicket)
                });
            }
            ...
            if (this.spinResponse.TotalPrize > 0) {
                ...
                if (this.spinResponse.IsJackpot) {
                    ...
                    {
                        cc.MiniPokerController.getInstance().activeArrow(true);
                    }
