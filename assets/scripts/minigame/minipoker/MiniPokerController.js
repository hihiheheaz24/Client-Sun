...
(function () {
    ...
    MiniPokerController = (function () {
        ...
        MiniPokerController.prototype.activeArrow = function (enable) {
            this.miniPokerView.activeArrow(enable);
        };
        ...
        MiniPokerController.prototype.createGoldenTicketView = function () {
            this.miniPokerPopupView.createGoldenTicketView();
        };

        MiniPokerController.prototype.destroyGoldenTicketView = function () {
            this.miniPokerPopupView.destroyGoldenTicketView();
        };
