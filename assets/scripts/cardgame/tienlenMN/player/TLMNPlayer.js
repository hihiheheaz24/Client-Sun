...
(function () {
    cc.TLMNPlayer = cc.Class({
        ...
        showefwin: function(sf){
            this.animWinClip.active = true;
            this.nodWin.node.active = true;
            this.nodWin.spriteFrame = this.sfWin[sf];
        },
