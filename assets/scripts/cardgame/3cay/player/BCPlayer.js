...
(function () {
    cc.BCPlayer = cc.Class({
        ...
        properties: {
            ...
            // nodeDiem: cc.Node,
            nodeDiem: cc.Sprite,
            spDiemWin: [cc.SpriteFrame],
            spDiemLoss: [cc.SpriteFrame]
        },
        ...
        onLoad: function () {
            ...
            // this.nodeDiem = this.node.getChildByName('nodeDiem');
        ...
        initUI: function () {
            ...
            this.nodeDiem.node.active = false;
        ...
        playerResultUI: function (isWin, amount, sum, chickenWin, isOwner, isCurrentPlayer, isPhatLuong, isBigWin) {
            ...
            if(isWin == true)
            {
                this.nodeDiem.node.active = true;
                this.nodeDiem.spriteFrame = this.spDiemWin[sum];
            }
            if(isWin == false)
            {
                this.nodeDiem.node.active = true;
                this.nodeDiem.spriteFrame = this.spDiemLoss[sum];
            }
            // cc.log("win", isWin)
            // this.nodeDiem.spriteFrame = this.spDiem[0];
