...
(function () {
    ...
    RoomController = (function () {
        ...
        RoomController.prototype.hideMain = function () {
            return this.roomView.hideMain();
        };
        ...
        RoomController.prototype.updateUIByRoomID = function (roomID) {
            return this.roomView.updateUIByRoomID(roomID);
        };
