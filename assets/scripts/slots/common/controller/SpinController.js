...
(function () {
    ...
    SpinController = (function () {
        ...
        SpinController.prototype.setMaxLinesText = function(maxLinesText) {
            this.spinView.setMaxLinesText(maxLinesText);
        };

        SpinController.prototype.getMaxLinesText = function() {
            return this.spinView.getMaxLinesText();
        };

        SpinController.prototype.setMinLinesText = function(minLinesText) {
            this.spinView.setMinLinesText(minLinesText);
        };

        SpinController.prototype.getMinLinesText = function() {
            return this.spinView.getMinLinesText();
        };
        ...
        SpinController.prototype.resumeAutoSpin = function () {
            return this.spinView.resumeAutoSpin();
        };
        ...
        SpinController.prototype.checkIsSpining = function () {
            return this.spinView.checkIsSpining();
        };
        ...
        SpinController.prototype.activeButtonAutoSpinMain = function (enable) {
            return this.buttonView.activeButtonAutoSpinMain(enable);
        };

        SpinController.prototype.updateUIButtonTry = function (isTry) {
            return this.buttonView.updateUIButtonTry(isTry);
        };
