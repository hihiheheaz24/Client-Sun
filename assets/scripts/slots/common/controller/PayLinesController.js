...
(function () {
    ...
    PayLinesController = (function () {
        ...
        PayLinesController.prototype.activeLineByID = function (lineID) {
            return this.payLinesView.activeLineByID(lineID);
        };

        PayLinesController.prototype.activeLines = function (count) {
            return this.payLinesView.activeLines(count);
        };
