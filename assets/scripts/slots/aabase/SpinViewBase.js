...
(function () {
    cc.SpinViewBase = cc.Class({
        ...
        // resume auto spin ngoai main game sau khi choi game mode khac
        resumeAutoSpin: function () {
            this.isAutoSpin = !!this.isResumeAutoSpin;
            this.isResumeAutoSpin = false;
        },
        ...
        setMaxLinesText: function(maxLinesText) {
            this.maxLinesText = maxLinesText;
        },

        getMaxLinesText: function() {
            return this.maxLinesText;
        },

        setMinLinesText: function(minLinesText) {
            this.minLinesText = minLinesText;
        },

        getMinLinesText: function() {
            return this.minLinesText;
        },
