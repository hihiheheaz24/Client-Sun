...
cc.Class({
    ...
    properties: {
        ...
        buttonHover: cc.AudioSource,

        increaseBet: cc.AudioSource,
        decreaseBet: cc.AudioSource,
        startSpin: cc.AudioSource,
    ...
    enableSound (enable) {
        if (this.normalWin) {
            ...
            this.buttonHover.mute = !enable  
            this.increaseBet.mute = !enable  
            this.decreaseBet.mute = !enable  
            this.startSpin.mute = !enable   
        }
    },
    ...
    getAudioClip  (clipType) {
        ...
        audioClip = null;
        switch (clipType) {
            case cc.AudioTypes.INCREASE_BET:
                audioClip = this.increaseBet;
                break;
            case cc.AudioTypes.DECREASE_BET:
                audioClip = this.decreaseBet;
                break;
            case cc.AudioTypes.START_SPIN:
                audioClip = this.startSpin;
                break;
            ...
            case cc.AudioTypes.NORMAL_CLICK:
                ...
                break;
            case cc.AudioTypes.BUTTON_HOVER:
                audioClip = this.buttonHover;
                break;
