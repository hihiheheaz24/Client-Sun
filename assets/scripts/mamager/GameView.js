...
(function () {
    cc.GameView = cc.Class({
        ...
        onLoad: function () {
            ...
            // console.log(cc.dynamicAtlasManager.enabled);
            ...
            if (response.M !== undefined && response.M.length > 0) {
                ...
                switch (m.M) {
                    ...
                    case cc.MethodHubOnName.JACKPOT_INFO:
                        cc.LobbyJackpotController.getInstance().onGetJackpotShootFishResponse(m.A[0]);
                        break;
                    case cc.MethodHubOnName.SYSTEM_NOTIFY:
                        cc.NotifyController.getInstance().onGetNotifyResponse(m.A[0])
                        break;
                }
            } else {
                //PING PONG
