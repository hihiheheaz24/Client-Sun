...
(function () {
    ...
    Hub = (function () {
        ...
        Hub.prototype.connect = function (controller, hubName, connectionToken, isReconnect, channelChatId) {
            if (hubName && controller) {
                ...
                try {
                    ...
                    if (hubName === cc.HubName.DragonTigerHub || hubName === cc.HubName.XocXocHub || hubName === cc.HubName.XocDiaLiveHub|| hubName === cc.HubName.ChatHub ||
                    ...
                    if (isReconnect) {
                        ...
                        if (hubName!==cc.HubName.SicBoHub) {
                    ...
                    try {
                        if (cc.sys.isNative) {
                            this.netControl = new WebSocket(url, [], cc.resources.load('resources/cacert.pem'));
                        } else {
        ...
        Hub.prototype.spin = function (lines, roomId) {
            ...
            switch (this.hubName) {
                ...
                case cc.HubName.TayDuThanKhiHub:
                    data.A = [cc.Config.getInstance().getDeviceType(),roomId];
                    break;
        ...
        Hub.prototype.betbaucua = function (betData) {
            var data = {
                M: cc.MethodHubName.BET,
            };
            data.A = [];
            data.A.push(betData.betInfos);
            console.log();
            this.send(data);
        };
        //Lode Bet
        ...
        //End Mau Binh ============================
        //Start XocDiaLive ============================
        Hub.prototype.tipDealer = function (tipAmount) {
            var data = {
                M: cc.MethodHubName.TIP_DEALER,
                A: [tipAmount]
            };
            this.send(data);
        };
        ...
        Hub.prototype.onOpen = function () {
            ...
            if (this.hubName!==cc.HubName.SicBoHub) {
                cc.PopupController.getInstance().hideBusy();
            }
            var self = this;
            self.pingPong();
